...
namespace STERLINGASSET.DATA.Helpers
{
    /// <summary>
    ...
    public class RepositoryFactories
    {
        ...
        /// </remarks>
        private IDictionary<Type, Func<STERLINGASSETContext, object>> GetFactories()
        {
            return new Dictionary<Type, Func<STERLINGASSETContext, object>>
                {
        ...
        /// </remarks>
        public RepositoryFactories(IDictionary<Type, Func<STERLINGASSETContext, object>> factories )
        {
        ...
        /// </remarks>
        public Func<STERLINGASSETContext, object> GetRepositoryFactory<T>()
        {
       
            Func<STERLINGASSETContext, object> factory;
        ...
        /// </remarks>
        public Func<STERLINGASSETContext, object> GetRepositoryFactoryForEntityType<T>() where T : class
        {
        ...
        protected virtual Func<STERLINGASSETContext, object> DefaultEntityRepositoryFactory<T>() where T : class
        {
        ...
        /// </remarks>
        private readonly IDictionary<Type, Func<STERLINGASSETContext, object>> _repositoryFactories;
